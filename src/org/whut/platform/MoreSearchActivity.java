...
public class MoreSearchActivity extends Activity{
	...
	{
		WeakReference<MoreSearchActivity> theactivity;
		public receiveDatahandle(MoreSearchActivity moreserachActivity) {
			theactivity=new WeakReference<MoreSearchActivity>(moreserachActivity);
		}

		@Override
		public void handleMessage(Message msg)
		{
			MoreSearchActivity mActivity=theactivity.get();
			if (msg.what==1) {
				MoreSearchActivity.sp_provinces.setAdapter(new ArrayAdapter<String>(mActivity, R.layout.simple_list_item_1,provinces));
				...
				MoreSearchActivity.sp_cities.setAdapter(new ArrayAdapter<String>(mActivity, R.layout.simple_list_item_1,cities));
				...
				MoreSearchActivity.sp_areas.setAdapter(new ArrayAdapter<String>(mActivity, R.layout.simple_list_item_1,areas));
