...
public class AreaRankPieChart extends Activity {
	String[] Name = { "风险等级 1", "风险等级 2", "风险等级 3", "风险等级 4", "风险等级 5","风险等级 6", "风险等级 7", "风险等级 8", "风险等级 9","风险等级10"};
	
	
	int[] RankValues;
	private static int[] COLORS = new int[] {Color.parseColor("#00FFFF"),Color.parseColor("#00FF7F"),Color.parseColor("#20B2AA"),Color.parseColor("#32CD32"),Color.parseColor("#FFFACD"),Color.parseColor("#FFFF00"),Color.parseColor("#DAA520"),Color.parseColor("#FFA500"),Color.parseColor("#FF1493"),Color.RED};
